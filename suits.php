...
<div class="container1">
  <p class="text">Suits</p>
  <img src="suits.jpg" alt="Game of Thrones" class="image" style="width: 270px; height: 350px;">
</div>
<!--
...
<p class="text" style="text-align: left; margin-top: 350px;">Score: <?php echo $s8["tv"];?> </p>
</div>
