...
-->
      <div class="col" style="align-self: center;">
       <!-- <div class="hide-md-lg">
        ...
        <button style="color:white;width:100%;background-color: #2471a3;text-align: center" class="btn1" value="submit" type="submit">Login</button>
      </div>
...
<div class="bottom-container">
  <div class="row">
    <div class="col">
      ...
      <a href="sign_up.php" style="color:white;width:100%;background-color: #34495e;" class="btn1">Sign up</a>
    </div>
    <!--
    <div class="col">
