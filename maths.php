...
$connection = mysqli_connect("localhost", "root", "","quizonn"); // Establishing Connection with Server
 // $db = mysqli_select_db("quizonn", $connection); // Selecting Database from Server
  ...
  while($r = mysqli_fetch_assoc($result2))
  {
   ...
   $sql = "SELECT ques,a,b,c,d FROM qasci WHERE id='$id'";
...
<?php
$sql3 = "SELECT ans FROM qasci WHERE id='$id'";
...
<p class="text" style="text-align: left; margin-top: 350px;">Score: <?php echo $s8["sci"];?> </p>
</div>
